...
Latent Dirichlet allocation (LDA) is a statistical model~\cite{blei2003latent}, where abstract topics in the model are defined as distributions over words.
