...
An active learning system samples a document to be labeled, and then queries a human annotator to get the label for that document.
In several different domains, data is readily available and easy to come by.
But even if the data is abundant, labels for the data is often harder and more expensive to come by~\cite{settles2012active}.
%TODO: Find another source for this too.
