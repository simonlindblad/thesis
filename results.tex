...
\begin{figure}[h!]
    ...
    \thirdsubfigimg{kärlsjukdom}{The counts of most likely topics for the ``kärlsjukdom'' label.}
    \quad
    \thirdsubfigimg{normal}{The counts of most likely topics for the ``normal'' label.}
    \thirdsubfigimg{blödning}{The counts of most likely topics for the ``blödning'' label.}
