...
The first technique used in this experiment was used to explore and try to find a relationship between the initial set of labels and the inherit structure of the data.
